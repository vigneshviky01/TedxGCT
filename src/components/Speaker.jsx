...
const Speaker = ({name,position,imgURL,right}) => {
  ...
  <img src={`${right?"/images/speakerRightFrame.png" : "/images/speakerLeftFrame.png"}`} className={`max-xl:hidden h-[172px] absolute ${right?"right-[130px]":"left-[240px]"} top-[50px] z-[-100]`}/>
    </div>
    </div>
  );
};
