...
const Speaker = ({name,position,imgURL,right,viewTalkLink}) => {
  return (
    ...
    <div className="relative   sm:px-20 max-w-7xl flex flex-col-reverse xl:flex-row   items-center justify-center xl:justify-end ">
      <div className={`speakerMobile max-sm:w-[335px]  max-xl:max-w-[460px] sm:min-w-[480px] md:min-w-[480px]  max-xl:px-5 xl:ml-48   xl:mr-34 flex flex-col max-xl:gap-3 max-sm:gap-1 ${right ? "xl:items-start " : "xl:items-end "}  `}>
        ...
        <div className="mt-2"><span className="xl:block xl:w-[690px]" dangerouslySetInnerHTML={{ __html: position }} /></div>
                ...
                <p className={`font-SpotifyMix max-xl:py-4 max-md:pt-4 max-xl:pt-7 xl:mt-[-50px] xl:mb-4 ${right ? "xl:pr-36" :"xl:pr-10"} w-full text-center xl:text-end text-[20px] sm:text-3xl text-border-red cursor-pointer z-30 xl:pt-3 `}><a href={viewTalkLink} target="_blank">View Talk</a></p>
