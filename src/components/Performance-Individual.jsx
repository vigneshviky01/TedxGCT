...
const PerformanceIndividual = ({name,desc,imgURL,link}) => {
  return (
    <div className="relative">
      ...
      <p className="font-SpotifyMix text-border-red text-[20px] sm:text-3xl text-center py-5 "><a href={link} target='_blank'>View Their Performance</a></p>
        </div>
      </div>
      </div>
      </div>
